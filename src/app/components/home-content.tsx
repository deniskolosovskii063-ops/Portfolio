      ...
      <div className="mx-auto w-full max-w-[1275px] px-4 sm:px-8 xl:px-0 flex flex-col gap-[60px] sm:gap-[78px] pt-[34px] pb-[80px]">
        ...
        <div className="flex flex-col gap-[48px] sm:gap-[76px] w-full max-w-[649px]">
          ...
          >
            ...
            <p>
              {fixText('За последние 6 лет проектировал сложные интерфейсы в MTS Cloud, разрабатывал финтех-продукт для европейского рынка, а сейчас руковожу направлением продуктового дизайна в IT-дочке Газпрома, где за 3 года вырос из продуктового дизайнера в лида и отвечаю за развитие цифровых сервисов и экосистемы с MAU 55 млн.')}
            </p>
          </motion.div>
