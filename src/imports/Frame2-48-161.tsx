...
function Frame2() {
  return (
    <div className="absolute h-[963px] left-[239px] overflow-clip top-[2116px] w-[642px]">
...
function Group() {
  return (
    <div className="absolute contents left-[238px] top-[2115px]">
      <Frame2 />
      <div className="absolute h-[798.118px] left-[834px] rounded-[30px] top-[2281px] w-[367.098px]" data-name="iPhone 17 Pro">
